                ...
                <div className="select-none flex flex-col gap-y-4 md:flex-row mx-auto border-3 border-blue-700 rounded-xl shadow-lg shadow-blue-900 p-4 mb-10 bg-gradient-to-br from-blue-100 via-purple-200 to-purple-100 w-75 md:w-190 lg:w-250 xl:w-350">
                    <div className="flex-1 lg:p-2 mr-4">
                                ...
                                <div className="flex flex-col gap-y-2">
                                    {
                                        cartProd[0] &&
                                            <>
                                                <Image onClick={() => router.push("/products/"+cartProd[0].id)} className="rounded-xl hover:cursor-pointer" src={cartProd[0].images[0]} width={70} height={50} alt="prod-image"></Image>
                                                <h1 className="font-sans text-blue-900">+{cartProd.length-1} more...</h1>
                                            </>
                                    }
                                </div>
                                <div className="flex flex-col gap-y-1 w-70">
                                    <h1 className="font-sans text-blue-900 font-bold text-lg">{cartProd.map((p) => p.productName).join(", ")}</h1>
                        ...
                        <div className="flex flex-row justify-between mt-4 items-center">
                            ...
                            <h1 className="font-sans text-blue-900 font-semibold text-lg md:mr-20">₹{(cartAmount*quantity).toFixed(2)}</h1>
                        </div>
                        ...
                        <div className="flex flex-row justify-between items-center mt-4">
                            ...
                            <h1 className="font-sans text-blue-900 font-bold text-xl md:mr-20">₹{((cartAmount*quantity)+40).toFixed(2)}</h1>
                        </div>
                    </div>
