        ...
        <div className="flex flex-col md:flex-row flex-wrap justify-center items-center my-5 gap-y-1 md:gap-x-8 lg:gap-x-4 xl:gap-x-8">
            {
                products.map((product) => (
                    <div key={product.id} className="bg-gradient-to-br from-blue-100 via-fuchsia-100 to-fuchsia-200 border-t-4 border-l-2 border-r-2 border-b-2 border-blue-700 w-75 md:w-80 rounded-xl shadow-xl mb-5 transition duration-300 ease-in-out">
                      <div className="flex flex-col items-center">
                        <Image src={product.images[0]} className="rounded-xl md:mt-2" width={300} height={10} alt='logo'></Image>
